...
public class IdleState implements AtmState{
    ...
    public void insertCard(AtmContext context, Card card, String pin){
        ...
        System.out.println("Card inserted, validating card");
        System.out.println("Validated");
        Account account = new Account("124324","Vatsal");
        context.setAccount(account);
        context.setState(StateFactory.getInstance().createSelectTransactionState());
    }
    @Override
